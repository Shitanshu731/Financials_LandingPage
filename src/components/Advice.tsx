  ...
  return (
    <div id="advice" className={`${styles.adviceMain} w-full py-20 `}>
        ...
        <div className='boxContainer mt-10 flex gap-3 flex-wrap w-full'>
            <MotionDiv initial={{x:"-100%",opacity:0}} animate={{x:0,opacity:1}}  className={`${styles.eachBox} w-[25rem] rounded-lg h-[20rem] items-center justify-center relative mx-auto`}>
            ...
            <MotionDiv initial={{y:"100%",opacity:0}} animate={{y:0,opacity:1}}  className={`${styles.eachBox} w-[25rem] rounded-lg h-[20rem] items-center justify-center relative mx-auto`}>
                <Image src={"/lock.png"} alt="shield" height={23} width={23} className='mt-10 text-3xl text-center items-center mx-auto mb-5'/>
            ...
            <MotionDiv initial={{x:"100%",opacity:0}} animate={{x:0,opacity:1}}  className={`${styles.eachBox} w-[25rem] rounded-lg h-[20rem] items-center justify-center relative mx-auto`}>
                <Image src={"/percentage.png"} alt="percentage" height={23} width={23}  className='mt-10 text-3xl text-center items-center mx-auto mb-5'/>
